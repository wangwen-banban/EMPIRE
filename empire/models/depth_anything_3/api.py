...
class DepthAnything3(nn.Module, PyTorchModelHubMixin):
    ...
    def inference(
        ...
        # Optional exporters and their service dependencies are intentionally omitted.
        if export_dir is not None:
            raise NotImplementedError(
                "This distribution contains the depth runtime only; export modules are not packaged."
            )
